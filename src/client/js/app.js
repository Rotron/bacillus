...
// Chat client is not available for mobile
...
function setupSocket(socket) {
    ...
    socket.on('welcome', function (playerSettings) {
        ...
        chat.addSystemLine('Connected to the game! Version 0.0.4');
        chat.addSystemLine('Type <b>-help</b> for a list of commands.');
        chat.addSystemLine('Brought to you by <b><i>Pydlua<b><i> and <b><i>FOSS<b><i> :)');
